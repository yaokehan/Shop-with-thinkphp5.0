<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"F:\wamp64\www\tp5_1\admin\index\view\goods\product_add.html";i:1556534127;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<!--[if lt IE 9]>
	<script type="text/javascript" src="/tp5_1/public/static/admin/lib/html5.js"></script>
	<script type="text/javascript" src="/tp5_1/public/static/admin/lib/respond.min.js"></script>
	<script type="text/javascript" src="/tp5_1/public/static/admin/lib/PIE_IE678.js"></script>
	<![endif]-->
	...
	<link href="/tp5_1/public/static/admin/fileinput/css/fileinput.css" media="all" rel="stylesheet" type="text/css" />
	<!-- 图片上传 -->
</head>
<body>

<div class="page-container">
	<form action="<?php echo U('product_add_goods'); ?>" method="post" class="form form-horizontal" id="form-article-add">
		...
		<script src="/tp5_1/public/static/admin/fileinput/js/fileinput.js" type="text/javascript"></script>
		<script src="/tp5_1/public/static/admin/fileinput/js/fileinput_locale_zh.js" type="text/javascript"></script>
...
<script type="text/javascript" src="/tp5_1/public/static/admin/lib/icheck/jquery.icheck.min.js"></script>
<script type="text/javascript" src="/tp5_1/public/static/admin/lib/jquery.validation/1.14.0/jquery.validate.min.js"></script>
<script type="text/javascript" src="/tp5_1/public/static/admin/lib/jquery.validation/1.14.0/validate-methods.js"></script>
<script type="text/javascript" src="/tp5_1/public/static/admin/lib/jquery.validation/1.14.0/messages_zh.min.js"></script>
...
<script type="text/javascript" src="/tp5_1/public/static/admin/static/h-ui/js/comment.js"></script>
				<!--/_footer /作为公共模版分离出去-->

				<!--请在下方写此页面业务相关的脚本-->
				<script type="text/javascript"  src="/tp5_1/public/static/admin/lib/webuploader/0.1.5/webuploader.min.js"></script>
				<script type="text/javascript" src="/tp5_1/public/static/admin/lib/ueditor/1.4.3/ueditor.config.js"></script>
				<script type="text/javascript" src="/tp5_1/public/static/admin/lib/ueditor/1.4.3/ueditor.all.min.js"> </script>
				<script type="text/javascript" src="/tp5_1/public/static/admin/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
				...
				<script type="text/javascript">
					...
					$("#file-0").on("fileuploaded", function (event, data, previewId, index) {
						...
						//前台显示图片的 字符的拼接
						$index = "/tp5_1/public";
						var div=$('<div class="input-group " id="imageDelete'+data.response['id']+'" style="margin-top:.5em;margin-right:2em; float:left;"><input type="hidden" name="imagepath[]" class="imagepath" value="'+data.response['id']+'"/><img src="'+$index+'.'+data.response['imagepath']+'"; class="img-responsive img-thumbnail" width="150"><a class="close" style="position:absolute; top: 0px; right: -14px;" title="删除这张图片" onclick="deleteImage('+data.response['id']+')">×</a></div>');
