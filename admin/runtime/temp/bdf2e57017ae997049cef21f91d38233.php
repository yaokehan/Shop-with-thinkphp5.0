<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:53:"F:\wamp64\www\tp5_1\admin\index\view\index\index.html";i:1556724753;}*/ ?>
...
<head>
	...
	<LINK rel="Bookmark" href="/tp5_1/public/static/admin/favicon.ico" >
	<LINK rel="Shortcut Icon" href="/tp5_1/public/static/admin//favicon.ico" />
	<!--[if lt IE 9]>
	...
	<link rel="stylesheet" type="text/css" href="/tp5_1/public/static/admin/static/h-ui/skin/default/skin.css" id="skin" />
	<link rel="stylesheet" type="text/css" href="/tp5_1/public/static/admin/static/h-ui/css/style.css" />
	<!--[if IE 6]>
			...
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				<ul class="cl">
					...
					<li class="dropDown dropDown_hover"> <a href="#" class="dropDown_A">admin <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="#">个人信息</a></li>
							<li><a href="http://localhost/tp5_1/public/admin.php/index/login/users_out">退出</a></li>
							<!--<li><a _href="admin/index/index/users_out" data-title="退出" href="javascript:void(0)">管理员列表</a></li>-->
						</ul>
					</li>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					...
					<li><a _href="admin/index/goods/product_category_add" data-title="分类管理" href="javascript:void(0)">分类管理</a></li>
					<li><a _href="admin/index/goods/product_list" data-title="产品管理" href="javascript:void(0)">产品管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-comments">
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a _href="admin/index/users/admin_role" data-title="角色管理" href="javascript:void(0)">角色管理</a></li>
					<li><a _href="admin/index/users/admin_permission" data-title="权限管理" href="javascript:void(0)">权限管理</a></li>
					<li><a _href="admin/index/users/admin_list" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-tongji">
...
<section class="Hui-article-box">
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="admin/index/index/welcome"></iframe>
		</div>
	</div>
</section>
