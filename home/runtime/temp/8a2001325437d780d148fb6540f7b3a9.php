<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:52:"F:\wamp64\www\tp5_1\home\index\view\index\lists.html";i:1556987964;s:52:"F:\wamp64\www\tp5_1\home\index\view\public/foot.html";i:1556250569;}*/ ?>
﻿<!DOCTYPE html>
<html>
    <head>
...
<link rel="stylesheet" href="/tp5_1/public/static/index/css/goodslist.css">
    ...
    <div class="mini-header-search">
        <div class="container">
            <div class="user-info">
                ...
                <a href="#" target="_blank" data-position-id="1000005">个人中心</a><span class="separate">|</span>
                <a href="#" target="_blank" data-position-id="1000043">我的订单</a><span class="separate">|</span>
                <a href="#" target="_blank" data-position-id="1000006"><i class="bag-icon f-icon"></i>购物袋（<span class="num">0</span>）</a>
            </div>
        </div>
    </div>
    <div id="header">
                        ...
                        <ul class="">
                            <li class="sub-menu-item">
                                ...
                                <div class="second-menu-wapper">
                                    <a href="#" target="_blank" data-position-id="1000012">女装</a>
                                    <a href="#" target="_blank" data-position-id="1000012">男装</a>
                                    <a href="#" target="_blank" data-position-id="1000012">内衣袜品</a>
                                    <a href="#" target="_blank" data-position-id="1000012">服饰配件</a>
                                </div>
                                <div class="third-menu-container">
                                    <ul>
                                        <li>
                                            <h3 class="second-title"><a href="#" target="_blank" data-position-id="1000012">女装</a></h3>
                                            <div class="sub-item">
                                                <a href="#" target="_blank" data-position-id="1000012">大衣风衣</a>
                                        ...
                                        <li>
                                            <h3 class="second-title"><a href="#f" target="_blank" data-position-id="1000012">男装</a></h3>
                                            <div class="sub-item">
                                            ...
                                            f    <a href="/category?catidList=1448" target="_blank" data-position-id="1000012">休闲裤</a>
                        ...
                        <li class="filter-item attribute-item" data-id="49">
                            <div class="filter-item-container">
                                <div class="filter-item-wrapper">
                                    ...
                                    <div class="sub-category">
                                        <a class="filter-element" data-pid="49" data-vid="4055" class="category-item" href="javascript:void(0)">2019年</a>
                                        <a class="filter-element" data-pid="49" data-vid="371806" class="category-item" href="javascript:void(0)">2018年</a>
                                        <a class="filter-element" data-pid="49" data-vid="531343" class="category-item" href="javascript:void(0)">2017年</a>
                                    </div>
...
<div class="widget-loading">
    <span class="content">
        <img src="/tp5_1/public/static/index/img/loading.gif">
        <span class="text">正在加载，请稍后…</span>
    </span>
</div>
                <ul class="product-list">
                    <?php foreach($data as $data): ?>
                    <a href="details?id=<?php echo $data['id']; ?>" target="_blank" data-position-id="1000012">
                    <li class="product-item product-item0" data-id="17170" data-skuid="94336" data-position-id="4000020">
                        <div class="product-wrapper">
                            <div class="img-container">
                                <img class="cover-img" src="/tp5_1/public/<?php echo $data['image'][0]['filepath']; ?>" data-title="<?php echo $data['goodsname']; ?>">
                            </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <a href="javascript:void(0)" target="_blank">
                                                    <img data-origin="/tp5_1/public/<?php echo $image['filepath']; ?>" src="/tp5_1/public/<?php echo $image['filepath']; ?>" class="swiper-lazy" alt="">
                                                </a>
                                                <?php endforeach; ?>
                                            </div>
                                        </div>
